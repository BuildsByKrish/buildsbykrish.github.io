...
},
{
  ...
  popularity: 85,
  imdbRating: 8.5,
  tags: ["space", "politics", "colonies", "mystery", "future"],
...
},
{
  ...
  popularity: 76,
  imdbRating: 7.1,
  tags: ["corporate", "mystery", "boss", "dark humor", "power"],
  description: "When a mysterious consultant takes over a gaming company, employees face sinister demands and unsettling changes in this twisted workplace thriller."
},
{
  id: 93,
  title: "The Rig",
  ...
  popularity: 74,
  imdbRating: 6.5,
  tags: ["oil rig", "fog", "isolation", "mystery", "supernatural"],
  description: "Stranded on a remote oil rig by a mysterious fog, the crew faces strange forces and rising paranoia as they fight to survive."
},
{
  id: 94,
  ...
  popularity: 72,
  imdbRating: 6.3,
  tags: ["Victorian", "myth", "serpent", "science vs faith", "romance"],
  description: "In Victorian England, a widow investigates reports of a mythical serpent — and forms a bond with a local pastor that challenges belief and reason."
},
{
  id: 95,
  ...
  popularity: 75,
  imdbRating: 7.6,
  tags: ["football", "class divide", "England", "origin story", "sports"],
  description: "Explore the origins of modern football as working-class players challenge elite clubs — and change the game forever."
},
{
  id: 96,
  title: "The Playlist",
  ...
  popularity: 78,
  imdbRating: 7.4,
  tags: ["Spotify", "startup", "music industry", "tech", "Sweden"],
  description: "The story of how Spotify revolutionized the music industry — told through the eyes of the people who made it happen."
},
{
  id: 97,
  ...
  popularity: 80,
  imdbRating: 7.0,
  tags: ["moon", "space mission", "water crisis", "Korea", "mystery"],
  description: "A team is sent to a lunar research base to retrieve a mysterious sample — but what they find could change humanity’s fate."
},
{
  id: 98,
  ...
  popularity: 76,
  imdbRating: 6.3,
  tags: ["parody", "murder mystery", "wine", "hallucination", "satire"],
  description: "A heartbroken woman thinks she witnesses a murder across the street — but her wine-fueled paranoia makes everything questionable in this satirical thriller."
},
{
  id: 99,
  ...
  popularity: 73,
  imdbRating: 6.4,
  tags: ["mutants", "experiment", "fugitive", "powers", "youth"],
  description: "Three young adults hunt the scientist who turned them into monsters — while grappling with their powers and a world that sees them as threats."
},
{
  id: 100,
  title: "The Watch",
  ...
  popularity: 70,
  imdbRating: 5.5,
  tags: ["Discworld", "guards", "magic", "satire", "fantasy"],
  description: "Inspired by Terry Pratchett’s Discworld, a ragtag group of misfit cops tries to save their corrupt city from dragons, conspiracies, and chaos."
}
];